...
var query = function query(size) {
  ...
  return function () {
    return styled.css(_templateObject$2, breakpoints[size] || defaultBreakpoints[size], styled.css.apply(undefined, arguments));
  };
};
...
var Hidden = styled__default.div(_templateObject$1, compute("xs"), compute("sm"), compute("md"), compute("lg"));
...
/* eslint-disable no-unused-vars */
var Section = styled__default.div(_templateObject, function (props) {
...
var passOn = function (children) {
  ...
  var response = React__default.isValidElement(children) ? React__default.cloneElement(children, process(children)) : React__default.Children.map(children, function (child) {
    return React__default.cloneElement(child, process(child));
  });
  return response;
};
...
var Wrapper = styled__default.div(_templateObject$4, function (props) {
...
var Box = styled__default.div(_templateObject$5, function (props) {
